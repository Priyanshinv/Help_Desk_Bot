...
var model = 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/e0a26263-411c-450d-8172-d805099a8668?subscription-key=4ced7e0838214b6094c2d6cf95520e38&verbose=true&timezoneOffset=0&q=';
...
bot.dialog('Bye', function (session,arg){
    //session.sendTyping();
    session.send("Bye.I hope we were able to assist you.");
session.endDialog();
}).triggerAction({
    matches: 'Bye'
});
